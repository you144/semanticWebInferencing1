...
public class PropertyChain {
    ...
    public static void main(String[] args) {
         ...
         */
        IRI ontology = IRI.create(new File("src/test/java/examples/propertyChain.owl").toURI());
        ...
        /**
         * Print the ABox entailment rules. Note the entailment that handles the
         * property chain isPartOf o isLocatedIn -> iPartOf: [ D_prp-spo2: (?u1
         * http://propertyChain.owl#isPartOf ?u2) (?u2
         * http://propertyChain.owl#isLocatedIn ?u3) -> (?u1
         * http://propertyChain.owl#isPartOf ?u3) ]
         */
        System.out.println("ABox entailment rules:");
        Print.printRuleSet(dle.getABoxRules());
