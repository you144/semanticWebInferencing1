...
/**
 * This is a simple example of defining a SPARQL query using the Jena API over
 * the ABox of DLEJena. The same approach can be used on the TBox.
 *
...
public class SparqlQuery {
    ...
    public static void main(String[] args) {
         ...
         */
        IRI ontology = IRI.create(new File("src/test/java/examples/wine_0.owl").toURI());
