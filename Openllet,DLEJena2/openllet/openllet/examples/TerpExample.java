...
public class TerpExample
{
	...
	private static final String ontology = "file:data/university0-0.owl";
	private static final String[] queries = new String[] { "file:data/lubm-query.terp", "file:data/lubm-query3.terp", "file:data/lubm-query5.terp" };
