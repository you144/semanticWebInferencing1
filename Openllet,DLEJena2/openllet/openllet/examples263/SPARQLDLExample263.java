 ...
 */
public class SPARQLDLExample263
{

	// The ontology loaded as dataset
	private static final String ontology = "file:data263/university0-0.owl";
	private static final String[] queries = new String[] {
			// One of the original LUBM queries
			"file:data/lubm-query4.sparql",
			// A SPARQL-DL query
			"file:data/lubm-sparql-dl.sparql",
			// A SPARQL-DL with the SPARQL-DL extensions vocabulary
			"file:data/lubm-sparql-dl-extvoc.sparql" };
	...
	{
		final SPARQLDLExample263 app = new SPARQLDLExample263();
		try
		{
			app.run();
		}
