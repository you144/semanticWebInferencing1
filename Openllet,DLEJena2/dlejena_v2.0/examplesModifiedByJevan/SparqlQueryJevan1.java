 ...
 */
public class SparqlQueryJevan1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        System.out.println("Instances of :hasChild :"); /* Jevan 2017sep */
        ResultSet results = qexec.execSelect();
        while (results.hasNext()) {
            /* https://jena.apache.org/documentation/query/app_api.html */
            QuerySolution soln = results.nextSolution() ; /* Jevan 2017sep */
            Resource s1 = (Resource) soln.get("?s").as(Resource.class); /* Jevan 2017sep */
            Resource s2 = (Resource) soln.get("?o").as(Resource.class); /* Jevan 2017sep */
            System.out.println(s1.getLocalName()+" :hasChild "+s2.getLocalName()); /* Jevan 2017sep */
        }
