...
/**
 * This is a simple example of loading an ontology in DLEJena. We exeplify also
 * on the way we can retrieve the rule base of the ABox rule reasoner (forwardRete) and
 * on some trivial TBox and ABox queries using the Jena API over the inferred models.
 *
...
public class LoadOntology {
    ...
    public static void main(String[] args) {
         ...
         */
        URI ontology = new File("data/man.owl").toURI();
        ...
        System.out.println("-------------------------");
        dlejena.utils.Print.printRuleSet(aboxRules);
